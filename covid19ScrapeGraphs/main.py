...
helpMsg = '''Provide 3 letter iso code which can be found here:
...
def main(country):
    ...
    TC_dict = {
                "days": days,
                "data": TC_data,
                "title": 'Number of total cases in ' + country,
    ...
    NC_dict = {
                "days": days,
                "data": NC_data,
                "title": 'New Cases Each Day in ' + country,
                "xlabel": 'days since Dec 31, 2019',
                "ylabel": 'New cases'}
    ...
    Deriv_dict = {
                ...
                "title": 'Derivative of total cases in ' + country,
                "xlabel": 'days since Dec 31, 2019',
                "ylabel": 'Derivative'}
    ...
    Sec_Deriv_dict = {
                ...
                "title": '2nd Derivative of total cases in ' + country,
                "xlabel": 'days since Dec 31, 2019',
...
if __name__ == "__main__":
    ...
    parser.add_argument("--iso", default="USA", help=helpMsg)
